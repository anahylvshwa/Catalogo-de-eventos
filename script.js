  ...
  lista.forEach(evento => {
    ...
    card.innerHTML = `
      ...
      <div class="card-content">
        ...
        <small>📅 ${new Date(evento.datetime).toLocaleDateString()}</small>

        <div class="card-bottom">
          <span class="price">
            ${evento.priceFrom === 0 ? "Gratis" : evento.currency + " " + evento.priceFrom}
          </span>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="modal-left">
          <img src="${evento.images[0] || 'https://via.placeholder.com/400x300'}">

          <h2>${evento.title}</h2>
          <p>📍 ${evento.city} - ${evento.venue}</p>
          <p>📅 ${new Date(evento.datetime).toLocaleString()}</p>
